...
int main()
{
	...
	{
		cout << "Exiting..." << endl;
		cardDeck.~DeckOfCards();//destructing
		exit(0); //if user does not want to play, exit
	}
	...
	{
		//cout << "1. " << firstCard.toString() << " 2. " << secondCard.toString() << endl;//test
